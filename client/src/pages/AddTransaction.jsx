...
function AddTransaction() {
    ...
    if (loading) return <p className="text-white/50 p-8">Loading...</p>;
    ...
    return (
        <>
            ...
            <div className="px-4 py-8 md:px-8">
                {/* Page heading */}
                <h1 className="text-white font-semibold text-xl mb-6">Add Transaction</h1>
